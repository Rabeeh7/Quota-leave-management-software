...
const { runFairnessEngine, recalculateAfterRemoval } = require('../services/fairnessEngine');
...
// POST /api/leader/fairness/run/:fridayId
router.post('/fairness/run/:fridayId', async (req, res) => {
  try {
